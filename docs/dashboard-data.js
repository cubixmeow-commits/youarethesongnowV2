...
window.MEOW_CONTROL = {
  ...
  workshopStatus: "Gemini multimodal portrait adapter implemented",
  workshopDetail: "Native Gemini image adapter ports V1 inline-portrait behavior. Song DNA is reused from selection. fal and Replicate remain optional experimental providers. Print/upscaling stay deferred.",
  promptSystemStatus: "V1 multimodal identity path restored for Gemini image",
  promptSystemDetail: "Identity-first prompt + each portrait as inlineData in one generateContent call. Lyrics remain transient for private Song DNA only and are never persisted.",
