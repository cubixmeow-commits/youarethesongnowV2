...
window.MEOW_CONTROL = {
  ...
  buildStatusDetail: "Hostinger live: invite + SMTP → Gemini Interactions Song DNA (Search + schema, store=false) → saved DNA → Gemini one/two-person portrait image → cron worker → gallery. 1058 tests pass after Luminous Night Studio Phase 1 correction. Quality consistency, no-text enforcement, live operations, rights and commercial gates remain open.",
  backend: "PHP",
