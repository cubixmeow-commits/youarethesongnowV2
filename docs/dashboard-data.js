...
window.MEOW_CONTROL = {
  ...
  brandStatus: "YS identity integrated (Round 008)",
  brandDetail: "Black/graphite, platinum and sapphire/cobalt. Production YS marks, wordmark, atmosphere, Create backdrops, Gallery empty state and paywall previews are integrated in the current web/mobile app. Review pack: design/review/round-008/. Flutter remains deferred.",
