...
window.MEOW_CONTROL = {
  ...
  brandStatus: "YS production identity delivered",
  brandDetail: "Black/graphite, platinum and sapphire/cobalt. Flat and premium YS marks, wordmark, app icon, responsive atmosphere/Create backgrounds, Gallery empty state and paywall previews are ready for current web/mobile integration. Flutter remains deferred.",
