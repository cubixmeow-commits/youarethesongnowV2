...
window.MEOW_CONTROL = {
  ...
  buildStatusDetail: "Hostinger live: invite + SMTP → Gemini Interactions Song DNA (Search + schema, store=false) → saved DNA → Gemini one/two-person portrait image → cron worker → gallery. 162 tests pass. Quality consistency, no-text enforcement, live operations, rights and commercial gates remain open.",
  backend: "PHP",
  ...
  brandStatus: "YS identity + design OS + Create-flow architecture",
  brandDetail: "Black/graphite, platinum and sapphire/cobalt. Round 008–009 assets and V1 showcase remain live. Permanent design docs live under docs/design/. 2026-08-31: DNA-first Create architecture locked (Quick Generate / Explore Options / Fine Tune) in screens/create-flow.md + ADR-20260831. No Create UX or Phase 2 token migration yet. Flutter remains deferred.",
