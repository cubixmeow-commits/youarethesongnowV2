...
**Scope:** Create entry and existing-contract song selection (Codex correction pass)
...
- State screenshots scroll the named target below the sticky top bar (`topbar height + 24px`) and fail capture when `targetVisible` is false. See `review-notes.json` for bounds.
- Entry shots at 320/390 scroll the song form below the top bar and assert artist field, title field, primary submit, and hidden resume row are all visible in the viewport.
...
| --- | --- | --- | --- |
| `create-entry-320.png` | `/create` | entry, fields + submit visible | 320 |
| `create-entry-390.png` | `/create` | entry, fields + submit visible | 390 |
...
| `song-loading-390.png` | `/create` | loading placeholder | 390 |
| `song-results-390.png` | `/create` | artwork-led result card | 390 |
| `song-results-768.png` | `/create` | result card | 768 |
| `song-results-1440.png` | `/create` | result card | 1440 |
| `song-no-results-390.png` | `/create` | no-match status | 390 |
| `song-error-390.png` | `/create` | error + Try again | 390 |
| `song-selected-390.png` | `/create` | selected card + Change song | 390 |
| `song-selected-1440.png` | `/create` | selected card | 1440 |
| `song-focus-390.png` | `/create` | keyboard focus on Find this song | 390 |
| `song-focus-result-390.png` | `/create` | keyboard focus on result button | 390 |
